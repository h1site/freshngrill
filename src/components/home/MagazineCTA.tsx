  ...
  return (
    <section className="relative py-[100px] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-neutral-950">
        ...
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-[#F77313]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-[#F77313]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href={recipeBasePath}
              className="group inline-flex items-center gap-3 bg-[#F77313] text-white px-10 py-5 font-medium uppercase tracking-wide text-sm hover:bg-white hover:text-black transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
            >
              {t.exploreRecipes}
            ...
            <Link
              href={blogBasePath}
              className="group inline-flex items-center gap-3 bg-transparent text-white px-10 py-5 font-medium uppercase tracking-wide text-sm border border-white/30 hover:bg-white hover:text-black hover:border-white transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
            >
              {t.readBlog}
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
