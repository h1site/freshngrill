...
export default function GuideEditForm({
  ...
  const [form, setForm] = useState({
    ...
    faq: (guide as any).faq || '',
    featured_image: guide.featured_image || '',
    pinterest_image: (guide as any).pinterest_image || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isNew) {
        ...
        currentGuideId = (newGuide as any).id;
        setGuideId(currentGuideId);

        // Add to guide-achat category
      ...
      if (enTranslation.title.trim() && currentGuideId) {
      ...
      if (isNew) {
        setSuccess('Guide créé!');
        router.push(`/admin/guides/${currentGuideId}`);
      } else {
        setSuccess('Guide mis à jour!');
        router.refresh();
      }
    } catch (err) {
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center">
                  <span className="text-gray-500 mr-2">/guide-achat/</span>
                  <input
                    type="text"
                    value={form.slug}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                  placeholder="Court résumé du guide..."
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Contenu du guide (HTML supporté)..."
                />
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <div className="flex items-center">
                  <span className="text-gray-500 mr-2">/en/buying-guide/</span>
                  <input
                    type="text"
