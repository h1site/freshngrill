          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <p className="text-gray-600">
              {isLoading ? (
                ...
                <>
                  <span className="font-semibold text-gray-900">{totalResults}</span> résultat{totalResults > 1 ? 's' : ''} pour &quot;{initialQuery}&quot;
                </>
              ) : (
          ...
          {!isLoading && totalResults === 0 && initialQuery && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 mb-8 max-w-md mx-auto">
                Nous n&apos;avons trouvé aucun résultat pour &quot;{initialQuery}&quot;.
      ...
      {!initialQuery && (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            Entrez un mot-clé pour rechercher parmi nos recettes et articles de blog.
          </p>
        </div>
      )}
    </div>
